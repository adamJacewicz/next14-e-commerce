...
export type ColorVariantFragment = { id: string, name: string };

export type SizeColorVariantFragment = { id: string, name: string };

export type SizeVariantFragment = { id: string, name: string };
